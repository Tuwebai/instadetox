-- =====================================================
-- INSTADETOX - STORAGE PARA AVATAR DE PERFIL (SSOT)
-- Fecha: 2026-02-25
-- Objetivo: permitir cambiar/eliminar foto de perfil con DB real.
-- =====================================================
...
create policy "profile_avatars_insert_own_folder" on storage.objects
